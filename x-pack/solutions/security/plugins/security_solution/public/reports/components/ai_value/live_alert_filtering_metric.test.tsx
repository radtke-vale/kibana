...
describe('LiveAlertFilteringMetric', () => {
  ...
  it('passes correct props to VisualizationEmbeddable and calls getExcludeAlertsFilters', () => {
    render(<LiveAlertFilteringMetric {...defaultProps} />);
  ...
  it('handles empty attackAlertIds correctly', () => {
    ...
    render(<LiveAlertFilteringMetric {...propsWithEmptyIds} />);
  ...
  it('handles single attackAlertId correctly', () => {
    ...
    render(<LiveAlertFilteringMetric {...propsWithSingleId} />);
  ...
  it('passes totalAlerts to getLensAttributes function', () => {
    ...
    render(<LiveAlertFilteringMetric {...props} />);
  ...
  it('memoizes getExcludeAlertsFilters call when props do not change', () => {
    const { rerender } = render(<LiveAlertFilteringMetric {...defaultProps} />);
    jest.clearAllMocks();
    rerender(<LiveAlertFilteringMetric {...defaultProps} />);
  ...
  it('calls getExcludeAlertsFilters when attackAlertIds change', () => {
    ...
    rerender(<LiveAlertFilteringMetric {...newProps} />);
